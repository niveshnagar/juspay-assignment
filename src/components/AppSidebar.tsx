...
const AppSidebar = () => {
  ...
  return isOpen ? (
    <div className=" bg-white border-[#1C1C1C1A] dark:bg-[#1C1C1C]  dark:border-white-10             px-4 py-5 flex flex-col gap-4  overflow-auto scrollbar-none w-[212px] h-screen leading-5 border-r">
      {/* Sidebar Header */}
      <div>
